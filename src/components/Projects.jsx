...
const projects = [
  {
    ...
    year: "2025",
    description: "A Multi-Agent System for Intelligent Report Analysis and Personalized Insights. Smart AI uses four agents—Identifier, Insightor, Suggestor, and Goal-Specified Agent—to extract data from PDFs, generate insights, and provide recommendations. Content is stored in a vector database, and a RAG-powered chatbot delivers accurate, real-time responses through an interactive interface.",
    tech: [
      { name: "React Js", percentage: 40, color: "#06B6D4" },
      { name: "FastAPI", percentage: 30, color: "#059669" },
      { name: "LLM (RAG)", percentage: 20, color: "#8B5CF6" },
      { name: "Vector DB", percentage: 10, color: "#F59E0B" },
    ],
